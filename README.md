...
![CodeBERT](https://img.shields.io/badge/CodeBERT-0e1116?style=flat-square&labelColor=0e1116&color=4fd1c5)
...
**`F1 0.915`**  ·  **`92% precisión`**  ·  [Demo en vivo ↗](https://huggingface.co/spaces/R0bl3s/php-ai-security-tfg)
...
1. **Análisis estático** — reglas y patrones que buscan construcciones peligrosas
   conocidas (inyección SQL, XSS, inclusión de ficheros, etc.).
2. **Análisis con IA** — un modelo **CodeBERT afinado** que aprende a reconocer
...
Modelo publicado en HuggingFace: [`R0bl3s/php-vuln-detector`](https://huggingface.co/R0bl3s/php-vuln-detector)
